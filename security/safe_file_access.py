...
def get_safe_path(filename: str, base_dir: str = SAFE_UPLOAD_DIR) -> str:
    ...
    """
    # If the user passed an absolute path, verify it directly, otherwise combine with base_dir
...
def safe_write_file(filename: str, content: str, base_dir: str = SAFE_UPLOAD_DIR, force: bool = False) -> str:
    """
