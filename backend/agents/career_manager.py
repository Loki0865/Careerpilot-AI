...
career_manager = Agent(
    ...
    - To add, update, track, view stats, or list deadlines for job applications: Delegate to 'tracker_agent'.
    ...
    """,
    sub_agents=[resume_agent, job_match_agent, interview_agent, tracker_agent],
    tools=[mcp_toolset]
)
